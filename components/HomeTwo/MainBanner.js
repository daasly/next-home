                                ...
                                <div className="col-lg-6 col-md-12">
                                    <div className="banner-image">
                                        ...
                                        <ReactWOW animation='zoomIn' delay='1s'>
                                            <img src={require("../../images/home-one/home-one-shape1.png")} alt="image" />
                                        </ReactWOW>

                                        <ReactWOW animation='fadeInUp' delay='1s'>
                                            <img src={require("../../images/home-one/home-one-shape2.png")} alt="image" />
                                        </ReactWOW>

                                        <ReactWOW animation='zoomIn' delay='1s'>
                                            <img src={require("../../images/home-one/home-one-shape3.png")} alt="image" />
                                        </ReactWOW>

                                        <ReactWOW animation='rotateIn' delay='1s'>
                                            <img src={require("../../images/home-one/home-one-shape4.png")} alt="image" />
                                        </ReactWOW>
