                        ...
                        <div className="col-lg-8">
                            <div className="blog-details-desc">
                                ...
                                <div className="article-content">
                                    ...
                                    {this.props.ctaAnalyticsChallenges && <><p>So what are the obstacles between you and a successful analytics function? Before you implement or scale your business consider the following challenges and their solutions.</p><ol><li>Navigating Budget Limitations - Know your business needs before developing your strategy. Your strategy will call for tools and skill sets that need to be considered. These hefty expenses have the potential to derail effective future states.</li><li>Scaling Data Analytics - Always think down the road. How can you set up a system that can grow with the organization and adapt to the rapid pace of change?</li><li>Poor Quality of Data - Simply put, bad data leads to bad decisions. Invest in resources that eliminate or significantly reduce the potential of inaccurate data.</li></ol><p>If you’re ready to implement, scale or spot-check your Analytics program and need help figuring out where to start, Daasly can offer a few pointers. Schedule a complimentary <Link href="http://bit.ly/DiscoverDaasly1"><a target="_blank">discovery session</a></Link> today to get started. We help companies like yours transform into data-driven businesses. Our outsourced Business Intelligence solution can do it all. Let us empower your organization and demonstrate your impact to stakeholders. Want to dive deeper? We would love to help. Get in <Link href="/contact"><a>contact</a></Link> today.</p><p>Read the complete article that inspired this post <Link href='https://insidebigdata.com/2020/09/01/top-3-data-analytics-challenges-and-how-to-resolve-them/'><a target='_blank'>here</a></Link>.</p></>}
                                    {!this.props.ctaAnalyticsChallenges && !this.props.ctabusinessIntelligencePropels || !this.props.ctaDataDriven || !this.props.ctaSmallMoments || !this.props.ctaMarathon || !this.props.ctaFirstStep || !this.props.ctaDataBuyIn || !this.props.ctaDomoAWS || !this.props.ctaGTM || !this.props.ctaGADimensions || !this.props.ctaRealTime || !this.props.ctaStrategy || !this.props.ctaCreativeData || !this.props.ctaCreativeData || !this.props.ctaCovid && <p>Read the complete article that inspired this post <a target="_blank" href={this.props.articleLink}>here</a>.</p>}
