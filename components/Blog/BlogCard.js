			...
			{/* Pagination */}
					<div className="col-lg-12 col-md-12">
						<div className="pagination-area">
								...
								<span className="prev page-numbers" onClick={() => {
									if (pageOne) {
										setPageTwo(false)
										setPageThree(false)
										setPageFour(false)
							...
							<span onClick={() => {
								...
								// setPageThree(false)
								// setPageFour(false)
							}}className={pageOne ? "page-numbers current" : "page-numbers"}>1</span>
							...
							<span onClick={() => {
								...
								// setPageThree(false)
								// setPageFour(false)
							}}className={pageTwo ? "page-numbers current" : "page-numbers"}>2</span>
							...
							<span onClick={() => {
								...
								<span className="next page-numbers" onClick={() => {
									if (pageOne) {
										setPageOne(false)
										setPageTwo(true)
										// setPageThree(false)
